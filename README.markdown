...
This directory contains source files for the __UNDEFINED__ language morphology
...
In order to compile and use __UNDEFINED__ language morphology and dictionaries,
you need:
...
The __UNDEFINED__ language sources can be acquired using `giella SVN
